...
| `AUTH_SERVICE_DEVELOPMENT_GOVERNANCE_ADOPTION_V2` | invariant | proposed | none | Governance v1.0.0 whole-authority successor candidate：三轴 Authority/Plan/Assurance 路由、Execution Mandate、route validator 与 DONE_WHEN/EXPANSION_TRIGGER stop control；仅治理采用，不改变产品、运行或生产 |
