...
| `AUTH_SERVICE_AGENTCORE_CANARY_GRANT_SUPPLY_STAGE_W_EXECUTION_V1` | implementation | proposed | none | Stage W exact executable、exclusive three-file boundary、临时 PostgreSQL replay 与 closed apply evidence |
