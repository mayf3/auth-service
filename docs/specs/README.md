...
|---|---|---|---|---|
| `AUTH_SERVICE_AGENTCORE_CANARY_GRANT_SUPPLY_V1` | implementation | proposed | none | 严格增补 Stage W exact migration path、exclusive three-file boundary 与 closed apply-evidence input；原 accepted Stage W 语义不变，Stage F 仍被阻塞 |
