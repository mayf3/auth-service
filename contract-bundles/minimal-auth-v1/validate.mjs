...
check([...audienceIds].sort(asciiCompare).join('\0')
  === ['adc-v2', 'agent-core-notification-ingress-v1', 'agent-principal-resolution', 'agent-session-messaging', 'scheduler', 'svc-auth', 'svc-forum', 'svc-okr', 'svc-workflow'].sort(asciiCompare).join('\0'), 'registry: first-wave Audience set changed');
